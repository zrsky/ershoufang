...
var URI = 'https://ershouche.test.91xinxiang.com';

var URICAR = 'https://ershouche.test.91xinxiang.com/api/index/lists';
var fetch = require('./fetch');

function getCarApi(type,params){
  return fetch(URICAR,type,params);
}

function findCar(type){
  ...
  return getCarApi(type, search ? Object.assign(params, { q: search }) : params).then(function (res) {
    return res.data;
  });
}
...
module.exports = { find: find, findOne: findOne,findCar:findCar };
